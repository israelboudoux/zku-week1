...
describe("Multiplier3 with Groth16", function () {
    ...
    it("Should return true for correct proof", async function () {
        const { proof, publicSignals } = await groth16.fullProve({"a":"2","b":"3","c":4}, 
            "contracts/circuits/Multiplier3_groth16/Multiplier3_js/Multiplier3.wasm",
            "contracts/circuits/Multiplier3_groth16/Multiplier3_final.zkey");
...
describe("Multiplier3 with PLONK", function () {
    ...
    it("Should return true for correct proof", async function () {
        const { proof, publicSignals } = await plonk.fullProve({"a":"2","b":"3","c":4}, 
            "contracts/circuits/Multiplier3_plonk/Multiplier3_js/Multiplier3.wasm",
            "contracts/circuits/Multiplier3_plonk/Multiplier3_final.zkey");
        ...
        expect(await verifier.verifyProof(aProof, Input)).to.be.true;
    });
